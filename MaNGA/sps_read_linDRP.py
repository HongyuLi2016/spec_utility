...
class read_DRP:
    def __init__(self, fname):
        ...
        self.header1 = hdulist['FLUX'].header
        self.header2 = hdulist['IVAR'].header
        self.flux = hdulist['FLUX'].data
        self.ivar = hdulist['IVAR'].data
        self.mask = hdulist['MASK'].data
        self.wave = hdulist['WAVE'].data
        self.specres = hdulist['SPECRES'].data
        self.specresd = hdulist['SPECRESD'].data
        self.bsinfo = hdulist['OBSINFO'].data
        self.gimg = hdulist['GIMG'].data
        self.rimg = hdulist['RIMG'].data
        self.iimg = hdulist['IIMG'].data
        self.zimg = hdulist['ZIMG'].data
        self.gpsf = hdulist['GPSF'].data
        self.rpsf = hdulist['RPSF'].data
        self.ipsf = hdulist['IPSF'].data
        self.zpsf = hdulist['ZPSF'].data
        self.gcorrel = hdulist['GCORREL'].data
        self.rcorrel = hdulist['RCORREL'].data
        self.icorrel = hdulist['ICORREL'].data
        self.zcorrel = hdulist['ZCORREL'].data
    ...
    def voronoiBin(self, targetSN=30, save=True, outFolder='spec',
        ...
        good = self.good_spaxel.reshape(-1) * (self.sn > 5.0).reshape(-1)
